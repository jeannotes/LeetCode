...
if(i>start&&nums[i]==nums[i-1])
			continue;
			这个是不对的，因为每一次的变换使得数组再次变得无序啊 ，这里说法不对09010-09001-09100-09010
			声明一下，不是再次无序，其实不是很准确，应该是 相隔两数相同，会出现两次，还行，马马虎虎
*/
//不会啊
//还是不会啊，完全不会啊 把 001 这个列子多推下就行 001 010  001 不行了 ,忘记插入了
